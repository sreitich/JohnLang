...
const semanticChecks = [
    ...
    ["Initialize with empty array", "todo a: []!"],

    ["Class declaration", "doohickey Square { slapTogether(handful l) { handful me.length: l! } }"],

    ["Assign arrays", "todo a: []! let b: [1]! a: b! b: a!"],

    ["Assign to array element", "todo a: [1, 2, 3]! a[1]: 100!"],

    ["initialize with empty map", "almanac a: {}!"],

    ["Assign maps", "almanac a: {}! almanac b: {1: 2}! a: b! b: a!"],

    ["Assign to map element", "almanac a: {1: 2, 4: 8}! a[1]: 4!"],
